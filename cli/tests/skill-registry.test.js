...
test("the real registry contains exactly the three built-in Skills, in a fixed order", () => {
  assert.deepEqual(skillIds(), ["change-context", "requirements-analysis-instructions", "architecture-definition"]);
});
