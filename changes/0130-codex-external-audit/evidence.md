...
| --- | --- | --- | --- | --- |
| C0130-F1 | High | Manifest-backed `aief close --yes` reports success but leaves the authoritative manifest open | Open — fix Change opened | 0131-manifest-close-persistence |
...
| C0130-F3 | Medium | Change 0122 multi-agent evidence records a modification forbidden by its own specification | Open | TBD |
| C0130-F4 | Low | Change 0122 CI evidence retains stale, contradictory pre-confirmation language after CI passed | Open | TBD |
