...
- multitenant (weak): keyword "tenant" found in README.md

Recommended Skills:

- multitenant-saas-architect: Multi-tenant architecture detected (keyword "tenant" found in README.md) — weak signal
- security-rbac-reviewer: Multi-tenant architecture detected (keyword "tenant" found in README.md) — weak signal
