...
See [docs/AIEF-1.0-READINESS.md](AIEF-1.0-READINESS.md) for the conditions that lift these restrictions, and [docs/getting-started.md](../getting-started.md) for how to work within them safely.
