...
Companion reading: [docs/concepts.md](../concepts.md) (the model these tensions stress), [knowledge/decisions.md](../../knowledge/decisions.md) (ADR-008, ADR-009, ADR-012), [docs/workflow.md](../workflow.md#starting-from-a-requirement-source), [docs/AIEF-1.0-READINESS.md](AIEF-1.0-READINESS.md).
