...
Companion reading: [docs/workflow.md](../workflow.md) (canonical workflow), [docs/dogfooding-findings.md](dogfooding-findings.md) (the findings ledger this document acts on), [docs/concepts.md](../concepts.md), [docs/runtime-governance-open-questions.md](runtime-governance-open-questions.md).
