...
svg_content = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1360 840" width="1360" height="840" style="background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  <defs>
  ...
  <rect width="1360" height="840" fill="#ffffff"/>

  <!-- Header Banner -->
  <g transform="translate(40, 20)">
    <text x="0" y="20" font-size="19" font-weight="800" fill="#0f172a" letter-spacing="-0.5px">AIEF CORE 3.0 WORKFLOW LIFECYCLE</text>
    <text x="0" y="38" font-size="12.5" font-weight="500" fill="#64748b">Canonical Architecture &amp; Governance Model</text>
  </g>
  ...
  <g transform="translate(40, 115)">
    ...
    <g transform="translate(20, 68)">
      ...
      <text x="16" y="110" font-size="12" fill="#64748b">repository readiness prior to adoption.</text>
    </g>
    ...
    <g transform="translate(20, 244)">
      ...
      <text x="14" y="24" font-family="monospace" font-size="14" font-weight="bold" fill="#38bdf8">&gt;_</text>
      <text x="36" y="24" font-family="monospace" font-size="14" font-weight="bold" fill="#ffffff">aief init / adopt</text>
      ...
      <text x="16" y="90" font-size="12" fill="#64748b">Initializes AGENTS.md governance rules and</text>
      <text x="16" y="110" font-size="12" fill="#64748b">establishes project context structure.</text>
    </g>
  ...
  <g transform="translate(485, 115)">
    ...
    <g transform="translate(20, 68)">
      ...
      <text x="16" y="90" font-size="12" fill="#64748b">Assembles specs, rules, skills, and code</text>
      <text x="16" y="110" font-size="12" fill="#64748b">context into a deterministic prompt.</text>
    </g>
    ...
    <g transform="translate(20, 244)">
      ...
      <text x="36" y="24" font-size="14" font-weight="bold" fill="#ffffff">AI Assistant</text>
      ...
      <text x="16" y="66" font-size="13.5" font-weight="700" fill="#0f172a">Claude, Gemini, Codex, Cursor...</text>
      <text x="16" y="90" font-size="12" fill="#64748b">Executes task implementation and code</text>
      <text x="16" y="110" font-size="12" fill="#64748b">refactoring following project conventions.</text>
    </g>
  ...
  <g transform="translate(930, 115)">
    ...
    <g transform="translate(20, 68)">
      ...
      <text x="16" y="90" font-size="12" fill="#64748b">Runs automated verification rules and</text>
      <text x="16" y="110" font-size="12" fill="#64748b">validates evidence completeness.</text>
    </g>
    ...
    <g transform="translate(20, 420)">
      ...
      <text x="14" y="24" font-family="monospace" font-size="13" font-weight="bold" fill="#38bdf8">&gt;_</text>
      <text x="34" y="24" font-family="monospace" font-size="13" font-weight="bold" fill="#ffffff">aief status --next</text>

      <g transform="translate(200, 9)">
        <rect x="0" y="0" width="45" height="18" rx="9" fill="#3730a3"/>
        <text x="22.5" y="13" font-size="9" font-weight="700" fill="#ffffff" text-anchor="middle">User</text>
        <rect x="50" y="0" width="92" height="18" rx="9" fill="#9a3412"/>
        <text x="96" y="13" font-size="9" font-weight="700" fill="#ffffff" text-anchor="middle">Outputs</text>
      </g>

      <text x="16" y="66" font-size="13.5" font-weight="700" fill="#0f172a">Get next recommended action</text>
      <text x="16" y="90" font-size="12" fill="#64748b">Provides clear guidance for starting</text>
      <text x="16" y="110" font-size="12" fill="#64748b">or advancing the next Change cycle.</text>
    </g>
  </g>

  <!-- Fail Loopback: G (verify fail) -> D (aief prompt) -->
  <g>
    ...
    <g transform="translate(875, 67)">
      <rect width="52" height="22" rx="11" fill="#fef2f2" stroke="#fca5a5" stroke-width="1.5" filter="url(#badge-shadow)"/>
      <text x="26" y="15" font-size="11" font-weight="800" fill="#991b1b" text-anchor="middle">fail</text>
    </g>
  </g>

  <!-- Next Change Loopback: I (aief status --next) -> C (aief new-change / enrich) -->
  <g>
    ...
    <g transform="translate(620, 778)">
      <rect width="120" height="24" rx="12" fill="#eef2ff" stroke="#a5b4fc" stroke-width="1.5" filter="url(#badge-shadow)"/>
      <text x="60" y="16" font-size="11" font-weight="800" fill="#3730a3" text-anchor="middle">Next Change</text>
    </g>
  </g>
</svg>
"""
